...
| Code | Status | Meaning |
|------|--------|---------|
| `SDK_MALFORMED_RESPONSE` | 0 | The engine returned a response the client could not parse |
| `SDK_INVALID_PAYLOAD` | 0 | Request payload failed client-side validation |
| `SDK_INVALID_OHLCV` | 0 | The supplied OHLCV DataFrame is missing columns, misindexed, or otherwise invalid |
| `SDK_INVALID_SIGNALS` | 0 | The supplied signal series is invalid |
| `SDK_INVALID_STRATEGY` | 0 | The strategy object failed client-side validation |
